    ...
    <div className='w-full pt-[200px] pb-[20px] bg-[#ffd957]'>
      <div className="container">
        <div className="grid grid-cols-2 gap-[50px]">
          <div className="">
            <motion.h1 initial={{ opacity: 0, y: -200 }} animate={{opacity: 1, y: 0}} transition={{ duration: 1}} className='poppins text-[60px] font-semibold leading-[70px]'>Build your digital brand from zero to hero.</motion.h1>
            <motion.p initial={{ opacity: 0, y: 50 }} animate={{opacity: 1, y: 0}} transition={{ duration: 1}} className='poppins text-[15px] font-normal w-[420px] leading-[25px] mt-5 text-[#4d5459]'>Lorem ipsum dolor sit amet, consect adipiscing elit, sed do
