    ...
    <div className='w-full pt-[120px] md:pt-[200px] pb-[20px] bg-[#ffd957]'>
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[50px]">
          <div className="">
            <motion.h1 initial={{ opacity: 0, y: -200 }} animate={{opacity: 1, y: 0}} transition={{ duration: 1}} className='poppins text-[30px] lg:text-[40px] xl:text-[60px] font-semibold leading-[40px] lg:leading-[50px] xl:leading-[70px]'>Build your digital brand from zero to hero.</motion.h1>
