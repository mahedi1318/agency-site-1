      ...
      <div className="container">
        <div className="grid grid-cols-3 gap-[50px]">
          <div className="">
            ...
            <motion.h2 initial={{ opacity: 0, y: -150 }} animate={{opacity: 1, y: 0}} transition={{ duration: 1}} className='poppins text-[50px] font-semibold leading-[68px] mt-4'>We always serve various digital brands.</motion.h2>
