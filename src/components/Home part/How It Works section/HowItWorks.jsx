    ...
    <div className='py-[100px] bg-[#f3f4f6]'>
      ...
      <div className="relative w-full max-w-4xl">
        ...
        {experiences.map((exp, index) => (
          <div
            key={index}
            className={`mb-20 w-full flex ${exp.align === "right" ? "justify-end" : "justify-start"} relative`}
          >
            <div className={`w-1/2 ${exp.align === "right" ? "pl-1" : "pr-1"}`}>
              <div className={`bg-white rounded-lg p-6 shadow-md ${exp.align === "right" ? "ml-12" : "mr-12"}`}>
            ...
            <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-7 h-7 bg-[#bd9103] rounded-full flex items-center justify-center shadow-md border border-gray-200 z-10">
